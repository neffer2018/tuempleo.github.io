...
$conec = mysqli_connect("localhost","root","","empleo");
  if ($conec) {
      $qry = "SELECT aprendiz.id_apre as id,aprendiz.nombre as nombre,aprendiz.apellido as apellido,portafoleo.nombre_archivo as nom_archivo,hoja_de_vida.nombre_hoja as hoja
      FROM aprendiz,portafoleo,hoja_de_vida 
      WHERE aprendiz.id_apre = portafoleo.id_apre and aprendiz.id_apre = hoja_de_vida.id_apre and aprendiz.area = 'adsi'";
        ...
        <thead class="thead-inverse">
         ...
         <tbody>
           ...
           <tr>
             ...
             <td><?php echo $datos['hoja']; ?></td>
             <td><a href="php/download_hoja.php?nomA=<?php echo $datos['hoja']; ?>" ><span class="fa fa-arrow-down"> Download</span></a></td>
           </tr>
           <?php endforeach; ?>
         </tbody>
      </table>
